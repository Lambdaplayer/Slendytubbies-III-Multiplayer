table.Merge( _LAMBDAPLAYERSWEAPONS, {
    st_xix_pistol = {
        model = "models/lambdaplayers/weapons/st3/w_st3_xix.mdl",
        ...
        reloadsounds = { 
            ...
            { 1.0, "lambdaplayers/weapons/SlendytubbiesSFX's/xix/xix_magin.wav" },
...
OnThink = function( lambda )
	...
	if balanceAdjustment:GetBool() then
		_LAMBDAPLAYERSWEAPONS["st_xix_pistol"].damage = 14
        _LAMBDAPLAYERSWEAPONS["st_xix_pistol"].spread = 0.133
	else
        _LAMBDAPLAYERSWEAPONS["st_xix_pistol"].damage = 21
        _LAMBDAPLAYERSWEAPONS["st_xix_pistol"].spread = 0.2
	end
end,
-------------------------------------------------------------------------------
