...
local hypeSnds = {
    ...
    "lambdaplayers/weapons/SlendytubbiesSFX's/katana/st3_katana_hype6.mp3", --Bangarang Ft Sirah - Skrillex
    ...
    "lambdaplayers/weapons/SlendytubbiesSFX's/katana/st3_katana_hype9.mp3", --Friday Night Funkin: Vs Sonic.exe EXEternal - Partner
    "lambdaplayers/weapons/SlendytubbiesSFX's/katana/st3_katana_hype10.mp3",
    "lambdaplayers/weapons/SlendytubbiesSFX's/katana/st3_katana_hype11.ogg", --Friday Night Funkin:Vs Sonic.exe Update 3 - You Can't Run Encore
