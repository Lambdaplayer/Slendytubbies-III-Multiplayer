...
function ENT:Initialize()
	...
	ParticleEffectAttach( "soul_trail", PATTACH_ABSORIGIN_FOLLOW, self, 0 )
...
function ENT:Explosion()
	...
	util.Effect( "cball_explode", effectdata )	 -- Big flame

	self.Entity:EmitSound(Sound("lambdaplayers/weapons/SlendytubbiesSFX's/grenade/explode"..math.random(1,3)..'.mp3', 90))
	
	local explo = ents.Create( "info_particle_system" )
		explo:SetOwner( self.Owner )
		explo:SetPos( self.Entity:GetPos() )
		explo:SetKeyValue( "iMagnitude", "150" )
		explo:SetKeyValue( "effect_name", "ExplosionCore_MidAir" )
		explo:SetKeyValue( "start_active", "1" )
		explo:Spawn()
		explo:Activate()
		--explo:Fire( "ExplosionCore_MidAir", "", 0 )	
